...
- 647376a: Typing spaces after a link no longer extends the link, including multiple spaces inserted in one transaction. Formatting changes and undo/redo preserve existing linked whitespace.
- Updated dependencies [647376a]
  - @tiptap/core@3.31.4
  - @tiptap/pm@3.31.4
...
- 647376a: Fix Enter and Shift-Enter inside React node views on iOS and Android.
- Updated dependencies [647376a]
  - @tiptap/core@3.31.4
  - @tiptap/pm@3.31.4
...
- 647376a: Atom block directives (`:::name {…} :::`) indented by up to 3 spaces are now tokenized, matching CommonMark indentation rules for block constructs.
- @tiptap/pm@3.31.4
