...
- Disclose when AI tools are used to generate code — the PR template includes an AI usage disclosure checkbox. Follow the project's guidelines on AI disclosure.
