...
export default {
  ...
  // The suggestion popup lives outside the editor's document, so the
  // experimental renderer's standalone `ReactRenderer` renders it exactly
  // like `@tiptap/react` does — same API, no editor coupling.
  render: () => {
    let component
