...
export default () => {
  const editor = useEditor({
    ...
    content: `
        <p>Hi everyone! This is the mention demo under the experimental React renderer.</p>
        ...
        <p>Type <code>@</code> to open the suggestion dropdown — it is rendered with the package's own <code>ReactRenderer</code>.</p>
