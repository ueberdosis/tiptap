...
// The default node mimics a computed node, based on some
// server configuration. A basic Paragraph node is extended
// here to simplify the example.
import DefaultNode from './Default.js'
// Our extended ListItem node to support `defaultNode` content.
...
export default {
  ...
  mounted() {
    this.editor = new Editor({
      ...
      // Use Paragraph list item content, which is exactly what our
      // DefaultNode node is extending.
      content: `
        <p>
        ...
        <ul>
          ...
          <li><p>And it has three list items.</p></li>
          <li><p>Here is the third one.</p></li>
        </ul>
        <p>
