...
test.describe('/src/Examples/Transition/Vue/', () => {
  ...
  test('should have two buttons and no active tiptap instance', async ({ page }) => {
    ...
    await expect(page.locator('#toggle-direct-editor').first()).toBeAttached()
    await expect(page.locator('#toggle-nested-editor').first()).toBeAttached()
  })
  ...
  test('clicking the buttons should show two editors', async ({ page }) => {
    ...
    await expect(page.locator('.tiptap').first()).toBeAttached()
