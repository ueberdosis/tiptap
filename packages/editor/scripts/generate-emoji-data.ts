...
import type { EmojiItem } from '../src/extensions/emoji/emoji.js'
import { removeVariationSelector } from '../src/extensions/emoji/helpers/removeVariationSelector.js'
...
fs.writeFileSync('./src/extensions/emoji/data/index.ts', content)
