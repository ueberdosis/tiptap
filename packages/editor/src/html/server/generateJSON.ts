...
import { type ParseOptions, DOMParser as PMDOMParser } from 'prosemirror-model'
...
export function generateJSON(
  ...
  if (!isNode) {
    throw new Error(
      'generateJSON can only be used in a Node environment\nIf you want to use this in a browser environment, use the `@tiptap/editor/html` import instead.',
    )
  }
