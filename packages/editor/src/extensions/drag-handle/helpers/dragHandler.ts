...
import { NodeRangeSelection, getSelectionRanges } from '@tiptap/editor/extensions/node-range'
import type { Node } from '@tiptap/editor/pm/model'
import { type SelectionRange, NodeSelection } from '@tiptap/editor/pm/state'
