...
/**
 * Checks whether a value is already a ProseMirror node or fragment. Matched on a
 * method both carry, because `instanceof` fails when prosemirror-model is loaded twice.
