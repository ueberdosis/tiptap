...
import type { EmojiItem } from '../src/emoji/emoji.js'
import { removeVariationSelector } from '../src/emoji/helpers/removeVariationSelector.js'
...
fs.writeFileSync('./src/emoji/data/index.ts', content)
