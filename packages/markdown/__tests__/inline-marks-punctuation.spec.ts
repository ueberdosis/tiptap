...
describe('Inline marks containing only punctuation', () => {
  ...
  describe('Italic marks with underscore fallback parsing', () => {
    it('should parse underscore italic when the closing underscore is followed by a word character', () => {
      const markdown = 'This is a small _te_st.'
      const json = markdownManager.parse(markdown)
    ...
    it('should not parse underscore emphasis inside snake_case words', () => {
      const markdown = 'Keep foo_bar_baz as plain text.'
      const json = markdownManager.parse(markdown)
        ...
        content: [
          {
            ...
            content: [
              {
                type: 'text',
                text: 'Keep foo_bar_baz as plain text.',
              },
            ],
          },
        ],
