...
- @tiptap/extension-bubble-menu@2.27.3
- @tiptap/extension-floating-menu@2.27.3
...
- 0fff08e: attach the contentDOM to the correct position inside a react node view
...
- 9711ab5: Fixed a bug that incorrectly added ref props when a component can't accept them (for example when React 19 is not used)
