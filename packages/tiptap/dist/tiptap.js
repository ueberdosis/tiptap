...
(function (global, factory) {
	...
	(factory((global.tiptap = {}),global.Vue));
	...
	var prototypeAccessors = { name: { configurable: true },defaultOptions: { configurable: true },type: { configurable: true },view: { configurable: true },schema: { configurable: true },plugins: { configurable: true } };
	...
	Object.defineProperties( Mark.prototype, prototypeAccessors$1 );
	...
	var prototypeAccessors$2 = { nodes: { configurable: true },marks: { configurable: true },pluginplugins: { configurable: true },views: { configurable: true } };

	prototypeAccessors$2.nodes.get = function () {
		return this.plugins
	...
	prototypeAccessors$2.marks.get = function () {
		return this.plugins
	...
	prototypeAccessors$2.pluginplugins.get = function () {
		return this.plugins
	...
	prototypeAccessors$2.views.get = function () {
		return this.plugins
	...
	Object.defineProperties( PluginManager.prototype, prototypeAccessors$2 );
